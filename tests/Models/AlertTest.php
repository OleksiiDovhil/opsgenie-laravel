...
class AlertTest extends PHPUnitTestCase
{
    ...
    public function attributes_can_be_set_in_the_constructor()
    {
        ...
        $this->assertEquals(['SQL'], $alert->tags);
    }

    /** @test */
    public function array_attributes_can_be_set_in_the_constructor()
    {
        $alert = new Alert('PJ Masks', [
            'tags' => 'SQL'
        ]);
    ...
    /** @test */
    public function array_attributes_can_be_set_in_the_constructor_as_array()
    {
        $alert = new Alert('PJ Masks', [
            'alias' => 'SQL Error',
            'description' => 'Error at SELECT * from Catsville',
        ...
        $this->assertEquals(['SQL', 'Error'], $alert->tags);
    }
